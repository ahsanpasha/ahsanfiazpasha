...
const projects = [
  ...
  },
  {
    ...
    longDesc: "Developed a dynamic WordPress-based platform for Surtaal USA to manage and showcase cultural and musical events across the United States. Features include event schedules, integrated media, and an engaging user interface designed to connect communities through live entertainment.",
  ...
  },
  {
    ...
    longDesc: "Engineered a fast and responsive logistics platform using React for Fahad Freight. The application streamlines city-to-city truck delivery services by providing an intuitive user interface for clients to request and manage freight transportation efficiently.",
  ...
  },
  {
    ...
    longDesc: "Developed a modern, multilingual corporate website for SIM d.o.o., a Croatian company specializing in advanced CNC production and precision metal machining. The platform highlights their engineering excellence and custom machinery capabilities with a fully responsive layout.",
    tech: ["React", "JavaScript", "Tailwind CSS"],
  ...
  },
  {
    ...
    longDesc: "Created a lightweight and interactive Chrome browser extension designed to enhance the web browsing experience. StyleSwipe enables users to effortlessly apply and switch between various visual themes on their favorite websites, utilizing optimized background scripts and a sleek popup interface.",
